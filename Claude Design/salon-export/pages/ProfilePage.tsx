...
export default function ProfilePage() {
  ...
  return (
    <div className="salon-root" style={{ minHeight: '100vh' }}>
      ...
      <main style={{ position: 'relative', zIndex: 4, padding: '8px 32px 56px', display: 'flex', justifyContent: 'center' }}>
            ...
            <section className="salon-stats-row">
              ...
              <div className="salon-stat">
                ...
                <span className="salon-stat-value">
                  {stats.games_won}
                  <span style={{ fontSize: 12, color: 'rgba(246,241,227,0.55)', marginLeft: 6, fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>
                    {winRate}%
                  </span>
                </span>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              {message && (
                <p style={{
                  ...
                  color: message.ok ? '#a7d7a4' : '#e98e8e',
                }}>{message.text}</p>
              )}
              <button
                onClick={saveProfile}
